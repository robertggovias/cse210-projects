class Reference
{
    ...
    /* public void SetReference(string book, int chapter, int verseInit, int verseEnd){
        _book = book;
        _chapter = chapter;
        _verseInit = verseInit;
        _verseEnd = verseEnd;
    } */
    public void SetReference(string book, int chapter, int verseInit)
    {
        _book = book;
        _chapter = chapter;
        _verseInit = verseInit;
    ...
    {        
        ...
        _verseInit = verseInit;
        _verseEnd = verseEnd;
        if (_verseInit == _verseEnd){
            _reference = book + " " + _chapter.ToString() + ":" + _verseInit.ToString();
        }
        else{
        _reference = _book + " " + _chapter.ToString() + ":" + _verseInit.ToString()
                + " - " + _verseEnd.ToString();
